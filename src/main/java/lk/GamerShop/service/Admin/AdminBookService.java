...
public class AdminBookService {
    ...
    public String getBooks(int page){
        ...
        try {
            Query<Book> query = session.createQuery("from Book b order by b.id ASC ", Book.class);
            Long total = session.createQuery("select count(b) from Book b", Long.class).uniqueResult();
            ...
            System.out.println(AppUtil.GSON.toJsonTree(bookDTOS));
            response.addProperty("totalBooks", total);
